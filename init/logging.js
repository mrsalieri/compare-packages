...
require("express-async-errors"); // Protects routers from crashes

module.exports = app => {
  // catches unhandled rejections and throws exception
  ...
  winston.stream = {
    // Stream for morgan to log http requests
    write: message => {
